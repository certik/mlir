...
set NATIVE_C=mlir_api_impl.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c mlir_wasm_dialect.c mlir_wasm_print.c mlir_lower_llvm_to_wasmssa.c mlir_stackify_wasmssa.c mlir_translate_wasmstack_to_binary.c tokenizer.c mlir_parser.c op_parsers.c mlir_classic_printer.c mlir_generic_printer.c
...
link /nologo /out:tinyc_native.exe ^
    ...
    mlir_api_impl.obj mlir_op_names.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.obj mlir_translate_to_wasm.obj mlir_wasm_dialect.obj mlir_wasm_print.obj mlir_lower_llvm_to_wasmssa.obj mlir_stackify_wasmssa.obj mlir_translate_wasmstack_to_binary.obj ^
