...
TINYC_C_FILES="examples/tinyc/lex.c examples/tinyc/parse.c examples/tinyc/emit.c examples/tinyc/driver.c mlir_op_names.c"
...
$CXX -g -o tinyc \
    upstream_main.o lex.o parse.o emit.o driver.o mlir_api_impl_upstream.o mlir_op_names.o \
