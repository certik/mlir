...
link /nologo /out:tinyc.exe ^
    ...
    mlir_op_names.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.obj mlir_wasm_to_wat.obj mlir_llvm_to_wasmssa.obj mlir_wasmssa_to_wasmstack.obj mlir_wasmstack_to_bin.obj mlir_generic_printer.obj mlir_api_impl_upstream.obj ^
