...
// Consolidated setter for results and their types (replaces set_results + set_result_types)
void mlir_operation_set_results_with_types(MlirOperation *op, MlirValue **results, MlirType **result_types, size_t count);

// Legacy setters (kept for backward compatibility - prefer mlir_operation_set_results_with_types)
