...
#line 103 "tokenizer.re"
	{ RET(TK_EOF) }
#line 225 "tokenizer.c"
yy2:
	++cur;
yy3:
#line 102 "tokenizer.re"
	{ RET(TK_ERROR) }
#line 231 "tokenizer.c"
yy4:
	yych = *++cur;
	if (yybm[0+yych] & 8) {
		goto yy4;
...
#line 151 "tokenizer.re"
	{ RET(TK_INTEGER) }
#line 391 "tokenizer.c"
yy25:
	++cur;
#line 128 "tokenizer.re"
	{ RET(TK_COLON) }
#line 396 "tokenizer.c"
yy26:
	++cur;
...
#line 121 "tokenizer.re"
	{ RET(TK_LANGLE) }
#line 406 "tokenizer.c"
yy28:
	++cur;
#line 127 "tokenizer.re"
	{ RET(TK_EQUAL) }
#line 411 "tokenizer.c"
yy29:
	++cur;
...
#line 116 "tokenizer.re"
	{ RET(TK_LBRACKET) }
#line 474 "tokenizer.c"
yy38:
	++cur;
#line 117 "tokenizer.re"
	{ RET(TK_RBRACKET) }
#line 479 "tokenizer.c"
yy39:
	yych = *++cur;
	if (yych <= 'Z') {
		if (yych == '-') goto yy69;
...
#line 145 "tokenizer.re"
	{ RET(TK_CARET_NAME); }
#line 761 "tokenizer.c"
yy71:
	++cur;
	cur = ctxmar;
#line 119 "tokenizer.re"
	{ RET(TK_LBRACE_END) }
#line 767 "tokenizer.c"
yy72:
	yych = *++cur;
	if (yych == '\n') goto yy71;
	goto yy46;
