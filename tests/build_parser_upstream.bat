...
set PROJ_C=parser.c tokenizer.c mlir_parser.c mlir_classic_printer.c mlir_generic_printer.c op_parsers.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c
...
link /nologo /out:parser_upstream.exe ^
    ...
    op_parsers.obj mlir_op_names.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.obj mlir_api_impl_upstream.obj ^
